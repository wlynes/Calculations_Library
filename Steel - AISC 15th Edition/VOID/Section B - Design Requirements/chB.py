...
def TablesB41(chez, b, t, E=29000, Fy=50):
    lam = b/t
    efy = math.sqrt(E/Fy)
...
def TableB41b(chez, b, t, E=29000, Fy=50, hc=1, hp=1, Mp=1, My=1):
    ...
    return lam, lamp, lamr, cat

def main():
    # define some stuff
    b = 15 # in, see Tables B4.1a and b
    t = 0.114 # in
    table_case = 15
    lam, lamp, lamr, cat = TableB41b(15, 7, .144, E=29000, Fy=50, hc=1, hp=1, Mp=1, My=1)
    print(lam, lamp, lamr, cat)
